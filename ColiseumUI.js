// =========================================
// ColiseumUI.js - VISTA Y ANIMACIONES V9.12 (FIX FONDO Y TAMAÑO BOTÓN)
// =========================================
...
window.ColiseumUI = {
    inyectarCSS: function() {
        ...
        style.innerHTML = `
            ...
            /* FIX: El fondo ahora es rgba(45, 62, 79, 0.98) para que sea visiblemente más claro */
            ...
            /* FIX: BOTÓN ENTRAR A LA ARENA - Ajustado para ser pequeño, delgado y centrado */
            #btn-start-battle, .btn-primary { 
                ...
                letter-spacing: 1px !important; /* Igual que retirarse */
                transition: 0.2s; 
                padding: 12px 25px !important; /* Más delgado */
                font-weight: bold !important; /* Igual que retirarse */
                font-size: 13px !important; /* Igual que retirarse */
                cursor: pointer; 
                width: max-content !important; /* Ajuste exacto al texto */
