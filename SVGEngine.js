...
function generarSvgGeno(genesVisuales) {
    ...
    const dicOjos = {
        ...
        // --- 8 OJOS NUEVOS DE FURIA (Sintaxis limpia sin espacios) ---
        ...
        furia_ceno_premium_brillo: `<path d="M 42 78 L 72 72 L 72 82 A 10 10 0 0 1 48 82 Z" fill="#fff" stroke="#1a2a36" stroke-width="3"/><circle cx="58" cy="85" r="4" fill="#ff4d4d"/><line x1="40" y1="65" x2="75" y2="70" stroke="#d4af37" stroke-width="6" stroke-linecap="round"/><circle cx="102" cy="85" r="4" fill="#ff4d4d"/><line x1="120" y1="65" x2="85" y2="70" stroke="#d4af37" stroke-width="6" stroke-linecap="round"/><circle cx="59.5" cy="83.5" r="1.5" fill="#fff"/><circle cx="100.5" cy="83.5" r="1.5" fill="#fff"/>`,
        rabia_dilatada_premium_brillo: `<circle cx="60" cy="85" r="12" fill="#fff" stroke="#1a2a36" stroke-width="3"/><circle cx="60" cy="85" r="9" fill="#1a2a36"/><circle cx="100" cy="85" r="12" fill="#fff" stroke="#1a2a36" stroke-width="3"/><circle cx="100" cy="85" r="9" fill="#1a2a36"/><ellipse cx="60" cy="85" rx="5" ry="9" fill="#e834eb" fill-opacity="0.3"/><ellipse cx="100" cy="85" rx="5" ry="9" fill="#e834eb" fill-opacity="0.3"/><circle cx="61.5" cy="83.5" r="2.5" fill="#fff"/><circle cx="101.5" cy="83.5" r="2.5" fill="#fff"/>`,
    ...
    const dicBocas = {
        ...
        // --- 8 BOCAS NUEVAS DE FURIA (Sintaxis limpia) ---
