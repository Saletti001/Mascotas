// =========================================
// SVGEngine.js - MOTOR VISUAL HD (SISTEMA MODULAR + PvZ + CEJAS)
// =========================================
...
function generarSvgGeno(genesVisuales) {
    ...
    svgContent += `
        <style>
            ...
            /* Agrupamos ojos y cejas en el parpadeo para que todo el ceño baje al parpadear */
    ...
    // ==========================================
    // 5. SISTEMA MODULAR PvZ (Ojos, Bocas y Cejas)
    // ==========================================
    ...
    const dicOjos = {
        ...
        pvz_girasol: `<path d="M 50 85 Q 60 70 70 85" fill="none" stroke="#1a2a36" stroke-width="4" stroke-linecap="round"/><path d="M 90 85 Q 100 70 110 85" fill="none" stroke="#1a2a36" stroke-width="4" stroke-linecap="round"/>`,
    ...
    const dicBocas = {
        base: `<path d="M 67 105 Q 80 120 93 105" fill="none" stroke="#1a2a36" stroke-width="5" stroke-linecap="round"/>`,
        pvz_guisante_boca: `<circle cx="80" cy="110" r="8" fill="#1a2a36"/>`,
    ...
    const dicCejas = {
        ninguna: ``, // Opción de no tener cejas
        pvz_jalapeno: `<path d="M 40 75 Q 55 65 70 82" fill="none" stroke="#1a2a36" stroke-width="6" stroke-linecap="round"/><path d="M 120 75 Q 105 65 90 82" fill="none" stroke="#1a2a36" stroke-width="6" stroke-linecap="round"/>`,
        tristes: `<path d="M 50 75 Q 60 65 70 75" fill="none" stroke="#1a2a36" stroke-width="4" stroke-linecap="round"/><path d="M 110 75 Q 100 65 90 75" fill="none" stroke="#1a2a36" stroke-width="4" stroke-linecap="round"/>`,
        levantada: `<path d="M 45 70 Q 55 60 65 70" fill="none" stroke="#1a2a36" stroke-width="4" stroke-linecap="round"/><path d="M 95 80 L 115 80" fill="none" stroke="#1a2a36" stroke-width="4" stroke-linecap="round"/>`,
        gruesas_rectas: `<line x1="50" y1="72" x2="70" y2="72" stroke="#1a2a36" stroke-width="6" stroke-linecap="round"/><line x1="90" y1="72" x2="110" y2="72" stroke="#1a2a36" stroke-width="6" stroke-linecap="round"/>`
    };

    // --- ALEATORIEDAD GEN-0 ---
    const nombresOjos = Object.keys(dicOjos);
    const nombresBocas = Object.keys(dicBocas);
    const nombresCejas = Object.keys(dicCejas);
    ...
    const cejaSeleccionada = safeData.eyebrow_type ? dicCejas[safeData.eyebrow_type] : dicCejas[nombresCejas[Math.floor(Math.random() * nombresCejas.length)]];
