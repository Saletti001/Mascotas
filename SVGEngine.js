// =========================================
// SVGEngine.js - MOTOR VISUAL HD (SISTEMA 16x16 PREMIUM CORREGIDO)
// =========================================
...
function generarSvgGeno(genesVisuales) {
    ...
    // 3. GEOMETRÍA DEL CUERPO (Formas Premium)
    switch (shape) {
        case "gota": 
    ...
    const dicOjos = {
        atento: `<circle cx="60" cy="88" r="6" fill="#1a2a36"/><circle cx="100" cy="88" r="6" fill="#1a2a36"/>`,
        guisante: `<circle cx="55" cy="85" r="10" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/><circle cx="55" cy="85" r="4" fill="#1a2a36"/><circle cx="105" cy="85" r="10" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/><circle cx="105" cy="85" r="4" fill="#1a2a36"/>`,
        nuez: `<circle cx="58" cy="85" r="8" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/><circle cx="58" cy="85" r="5" fill="#1a2a36"/><circle cx="102" cy="85" r="8" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/><circle cx="102" cy="85" r="5" fill="#1a2a36"/>`,
        ...
        picaro: `<path d="M 45 85 C 45 95, 60 95, 60 85 L 60 78 L 45 73 Z" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/><circle cx="55" cy="85" r="4.5" fill="#1a2a36"/><circle cx="105" cy="85" r="4.5" fill="#1a2a36"/>`,
        derpy: `<circle cx="56" cy="85" r="10" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/><circle cx="56" cy="85" r="4" fill="#1a2a36"/><circle cx="104" cy="88" r="5" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/><circle cx="104" cy="88" r="2.5" fill="#1a2a36"/>`,
        furia: `<circle cx="58" cy="88" r="10" fill="#ff4d4d" stroke="#1a2a36" stroke-width="3"/><circle cx="58" cy="88" r="4" fill="#1a2a36"/><circle cx="102" cy="88" r="10" fill="#ff4d4d" stroke="#1a2a36" stroke-width="3"/><circle cx="102" cy="88" r="4" fill="#1a2a36"/>`,
        cicatriz: `<line x1="48" y1="88" x2="72" y2="88" stroke="#1a2a36" stroke-width="6" stroke-linecap="round"/><circle cx="102" cy="85" r="9" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/><circle cx="102" cy="85" r="4" fill="#1a2a36"/>`,
        hipnotico: `<circle cx="60" cy="85" r="10" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/><circle cx="100" cy="85" r="10" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/>`,
        ojo_X: `<line x1="52" y1="80" x2="68" y2="96" stroke="#1a2a36" stroke-width="5"/><line x1="52" y1="96" x2="68" y2="80" stroke="#1a2a36" stroke-width="5"/><line x1="92" y1="80" x2="108" y2="96" stroke="#1a2a36" stroke-width="5"/><line x1="92" y1="96" x2="108" y2="80" stroke="#1a2a36" stroke-width="5"/>`,
        cyber: `<rect x="45" y="80" width="70" height="12" fill="#00ffff" opacity="0.6"/>`,
        ninja: `<rect x="25" y="75" width="110" height="20" fill="#1a2a36" rx="5"/><circle cx="60" cy="85" r="6" fill="#ffffff"/><circle cx="100" cy="85" r="6" fill="#ffffff"/>`,
        triste_pvz: `<path d="M 50 90 Q 60 75 70 90" fill="none" stroke="#1a2a36" stroke-width="5"/><path d="M 90 90 Q 100 75 110 90" fill="none" stroke="#1a2a36" stroke-width="5"/>`,
        felino: `<ellipse cx="60" cy="85" rx="8" ry="10" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/><ellipse cx="100" cy="85" rx="8" ry="10" fill="#ffffff" stroke="#1a2a36" stroke-width="3"/>`,
        pupila_vert: `<circle cx="60" cy="88" r="6" fill="#1a2a36"/><rect x="59" y="80" width="2" height="16" fill="#ffffff"/><circle cx="100" cy="88" r="6" fill="#1a2a36"/><rect x="99" y="80" width="2" height="16" fill="#ffffff"/>`
    };

    // --- CORRECCIONES Y NUEVOS RASGOS PREMIUM (Foco, Gafas unificadas, Monóculo sólido, Pestañeo centrado) ---
    
    // 1. Foco Re-incorporado (image_6.png) - Pupila amarilla brillante detallada
    dicOjos.foco = `
        <circle cx="60" cy="85" r="12" fill="#fff" stroke="#1a2a36" stroke-width="3"/>
        <circle cx="60" cy="85" r="5" fill="#fdfd96"/>
        <circle cx="61.5" cy="83.5" r="1.5" fill="#fff"/>
        <circle cx="100" cy="85" r="12" fill="#fff" stroke="#1a2a36" stroke-width="3"/>
        <circle cx="100" cy="85" r="5" fill="#fdfd96"/>
        <circle cx="101.5" cy="83.5" r="1.5" fill="#fff"/>
    `;

    // 2. Gafas (image_1.png) - Pupila unificada y perfectamente centrada
    dicOjos.gafas = `
        <g stroke="#1a2a36" stroke-width="3">
            <circle cx="60" cy="85" r="12" fill="#fff" fill-opacity="0.3"/>
            <circle cx="60" cy="85" r="4" fill="#1a2a36"/>
            <circle cx="100" cy="85" r="12" fill="#fff" fill-opacity="0.3"/>
            <circle cx="100" cy="85" r="4" fill="#1a2a36"/>
            <line x1="72" y1="85" x2="88" y2="85"/>
        </g>
    `;

    // 3. Monóculo (image_2.png) - Pieza sólida monopieza de metal bronce
    dicOjos.monoculo = `
        <circle cx="60" cy="85" r="12" fill="url(#${bronzeId})" stroke="#d4af37" stroke-width="4"/>
        <line x1="60" y1="73" x2="60" y2="60" stroke="#d4af37" stroke-width="2"/>
        <circle cx="100" cy="85" r="7" fill="#1a2a36"/>
        <circle cx="101.5" cy="83.5" r="2.5" fill="#fff"/>
    `;

    // 4. Pestañeo Aura (image_3.png) - Puntos mágicos perfectamente centrados
    const pestsAuraD = parpadoCentrado => `
        <g transform="translate(${parpadoCentrado ? 15 : -15}, 0)">
            <ellipse cx="60" cy="88" rx="10" ry="10" fill="#fff" fill-opacity="0.3"/>
            <circle cx="60" cy="88" r="4" fill="#00ffff"/>
        </g>
    `;
    dicOjos.pesta_aura = `<g transform="translate(15, 0)">${pestsAuraD(true)}</g><g transform="translate(-15, 0)">${pestsAuraD(false)}</g>`;
    ...
    const dicBocas = {
        ...
        vampiro_3_corregida: `
            <path d="M 62 108 L 98 108" fill="none" stroke="#1a2a36" stroke-width="5" stroke-linecap="round"/><polygon points="68,108 72,116 76,108" fill="#fff" stroke="#1a2a36" stroke-width="1.5"/><polygon points="78,108 82,118 86,108" fill="#fff" stroke="#1a2a36" stroke-width="1.5"/><polygon points="88,108 92,116 96,108" fill="#fff" stroke="#1a2a36" stroke-width="1.5"/>
        `,
