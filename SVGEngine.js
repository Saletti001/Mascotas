// =========================================
// SVGEngine.js - MOTOR VISUAL HD (PREMIUM PvZ ESTABLE + MONÓCULO ROJO)
// =========================================
...
function generarSvgGeno(genesVisuales) {
    ...
    // ==========================================
    // 5. SISTEMA MODULAR PvZ (Ojos y Bocas)
    // ==========================================
    ...
    const dicOjos = {
        ...
        feroz: `<line x1="48" y1="76" x2="67" y2="88" stroke="#1a2a36" stroke-width="5" stroke-linecap="round"/><path d="M 46 80 A 10 10 0 0 0 68 84 L 68 80 Z" fill="#ffffff"/><circle cx="58" cy="85" r="4" fill="#1a2a36"/><line x1="112" y1="76" x2="93" y2="88" stroke="#1a2a36" stroke-width="5" stroke-linecap="round"/><path d="M 114 80 A 10 10 0 0 0 92 84 L 92 80 Z" fill="#ffffff"/><circle cx="102" cy="85" r="4" fill="#1a2a36"/>`,
        ...
        // MONÓCULO CORREGIDO: Ojo premium detallado, con el monóculo integrado y punto rojo central.
        monoculo: `<circle cx="60" cy="85" r="12" fill="none" stroke="#d4af37" stroke-width="4"/><line x1="60" y1="73" x2="60" y2="60" stroke="#d4af37" stroke-width="2"/><circle cx="100" cy="85" r="7" fill="#1a2a36"/><circle cx="101.5" cy="83.5" r="2.5" fill="#fff"/><circle cx="100" cy="85" r="1.5" fill="#ff4d4d"/>`,
