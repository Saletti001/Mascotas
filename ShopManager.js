...
window.ShopManager = {
    ...
    iconosSVG: {
        ...
        // Biomutante (Corregido: Planta Mutante de 3 Hojas)
        "Biomutante": `<svg viewBox="0 0 100 100" width="1em" height="1em"><defs><linearGradient id="gBioLeaf" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stop-color="#69F0AE" /><stop offset="100%" stop-color="#2E7D32" /></linearGradient></defs><path d="M50 10 C60 30 70 40 50 55 C30 40 40 30 50 10 Z" fill="url(#gBioLeaf)"/><path d="M50 55 C70 50 90 60 90 75 C80 90 60 80 50 55 Z" fill="url(#gBioLeaf)"/><path d="M50 55 C30 50 10 60 10 75 C20 90 40 80 50 55 Z" fill="url(#gBioLeaf)"/><circle cx="50" cy="55" r="5" fill="#121822"/><path d="M50 55 L50 95" stroke="url(#gBioLeaf)" stroke-width="6" stroke-linecap="round"/></svg>`,
        ...
        // Tóxico (Corregido: Matraz de Veneno)
        "Tóxico": `<svg viewBox="0 0 100 100" width="1em" height="1em"><defs><linearGradient id="gToxVial" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stop-color="#C6FF00" /><stop offset="100%" stop-color="#558B2F" /></linearGradient></defs><path d="M35 15 L65 15 L65 30 L80 80 A10 10 0 0 1 70 95 L30 95 A10 10 0 0 1 20 80 L35 30 Z" fill="#121822" stroke="url(#gToxVial)" stroke-width="6" stroke-linejoin="round"/><path d="M26 60 L74 60 L78 80 A5 5 0 0 1 70 90 L30 90 A5 5 0 0 1 22 80 Z" fill="url(#gToxVial)"/><rect x="40" y="5" width="20" height="10" rx="3" fill="#8D6E63"/><circle cx="40" cy="70" r="4" fill="#121822" opacity="0.6"/><circle cx="55" cy="80" r="6" fill="#121822" opacity="0.6"/><circle cx="65" cy="65" r="3" fill="#121822" opacity="0.6"/><circle cx="50" cy="45" r="5" fill="#C6FF00"/><circle cx="40" cy="35" r="3" fill="#C6FF00"/></svg>`,
